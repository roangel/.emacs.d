(custom-set-variables
 ...
 '(package-selected-packages
   '(yaml-mode docker helm-tramp helm-gtags clang-format clang-format+ pdf-tools org-noter bibtex-completion helm-bibtex dockerfile-mode helm company-anaconda company-irony-c-headers company dap-mode cargo rust-mode helm-org org-projectile org-projectile-helm helm-ag ag helm-projectile helm-smex anaconda-mode swiper ivy psession projectile multi-term cmake-mode mode-line-bell leetcode arduino-mode multiple-cursors company-irony symon transient github-review magit company-tabnine py-autopep8 elpy irony-eldoc ggtags irony use-package zenburn-theme yasnippet xcscope sublime-themes spacemacs-theme smex smart-tabs-mode org2issue org-bullets org-babel-eval-in-repl noctilux-theme monokai-alt-theme material-theme highlight-symbol highlight-parentheses epc dired+ darkokai-theme cyberpunk-theme bm autopair))
