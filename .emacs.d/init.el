...
(require 'symon)
(symon-mode)
(setq symon-delay 0.2)
(setq symon-refresh-rate 20)
...
;;   ;; 							   )) ;; company-gtags makes it super slow when typing a dot (.)
;;   ;; 	)
...
;; Make grep work with fish shell:
...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (arduino-mode multiple-cursors company-irony company symon transient github-review forge magit company-tabnine py-autopep8 elpy ace-window irony-eldoc ggtags irony use-package zoom zenburn-theme yasnippet xcscope sublime-themes spacemacs-theme smex smart-tabs-mode org2issue org-bullets org-babel-eval-in-repl noctilux-theme monokai-theme monokai-alt-theme molokai-theme material-theme iedit highlight-symbol highlight-parentheses epc dired+ darkokai-theme cyberpunk-theme bm autopair)))
